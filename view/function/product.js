...
async function cargar_proveedores() {
    ...
    // Validar que el elemento exista antes de acceder a él
    const selectProveedor = document.getElementById("id_proveedor");
    if (selectProveedor) {
        selectProveedor.innerHTML = contenido;
    } else {
        console.warn("Elemento con id 'id_proveedor' no encontrado en el DOM.");
    }
}
