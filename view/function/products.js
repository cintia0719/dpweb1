async function listar_productos() {
    try {
        let respuesta = await fetch(base_url + '/controller/Products.php?tipo=listar');
...
async function insertar_producto() {
    ...
    try {
        ...
        // await = promesa
        let respuesta = await fetch(base_url + '/controller/Products.php?tipo=registrar', {
            method: 'POST',
            mode: 'cors',
            cache: 'no-cache',
            body: datos
...
async function listar_productosP() {
    try {
        let respuesta = await fetch(base_url + '/controller/Products.php?tipo=listarP');
        json = await respuesta.json();
        if (json.status) {
            let datos = json.contenido;
            let contenido_select = '<option value="" disabled selected>Seleccione</option>'; // Sin jquery
...
async function ver_producto(id) {
    ...
    try {
        let respuesta = await fetch(base_url + '/controller/Products.php?tipo=ver', {
            method: 'POST',
            mode: 'cors',
            cache: 'no-cache',
            body: formData
        ...
        if (json.status) {
            ...
            window.location = base_url + "/view-products";
        }
        console.log(json);
    } catch (e) {
        console.log('Ups, ocurrió un error ' + e);
...
async function actualizar_producto() {
    ...
    try {
        let respuesta = await fetch(base_url + '/controller/Products.php?tipo=actualizar', {
            method: 'POST',
            mode: 'cors',
            cache: 'no-cache',
            body: datos
